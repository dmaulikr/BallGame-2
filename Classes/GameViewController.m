...
- (void)loadView 
{
	...
	//总的场景控制器 opengl部分
	sceneController = [BGSceneController sharedSceneController];
	
	BGInputViewController * anInputController = [[BGInputViewController alloc] initWithNibName:nil bundle:nil];
	...
	[BGSwfMaker getSingleSwfMaker:@"002"];						//加载图片
